...
export default function Quiz({ words, setWords }) {
  ...
  const checkAnswer = (event) => {
    ...
    const correct = mode === 'wordToMeaning' ? expected.toLowerCase().includes(normalizedAnswer) : expected.toLowerCase() === normalizedAnswer;
